...
\ctexset {
	subsubsection = {
		format = \zihao{5}\heiti ,  % 所有subsection的字号为五号黑体左对齐
		number = \phantom{【}\arabic{subsubsection}.\!\!\!\!,                             % 设置序号为没有序号
	}
}
...
\section{实验内容与数据处理}
\subsection{实验原理}
\subsubsection{这是一个subsubsection标题}
内容
\subsubsection{这是另一个subsubsection标题}
内容
\subsection{实验内容}
\subsection{实验方法和内容}
